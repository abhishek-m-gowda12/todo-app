...
import io.abhishek.todoapp.repository.CategoryRepository;
import io.abhishek.todoapp.service.CategoryService;
import io.abhishek.todoapp.validators.CategoryValidator;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public List<CategoryDto> findAllByUserId(Long userId) {
        return categoryRepository.findCategoryByUserEntityId(userId).stream()
                .map(CategoryDto::fromEntity)
                .collect(Collectors.toList());
    }
